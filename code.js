...
//var numbers =[2,3,7,4,6,1,8,9]

//var result = numbers.indexof(6)

//console.log(result)

/*var names = ["jonas","mert","Yahya", "yussuf"];
...
/*var human = {
  ...
  country: "Deutschland",
  children:[
    "abu bakr", "mariam", "khaled ibn walid"
  ]
}
...
/*var age = prompt("trag dein alter ein");
...
/*var color = prompt("trag eine ampel farbe ein");
